...
本仓库采用 [MIT License](LICENSE)。欢迎贡献；提交代码或内容即表示你同意在 MIT 许可证下提供你的贡献。
...
- 不得提交真实姓名、聊天记录、日期、地址、私人答案、私人 URL 或任何可识别信息。
- 不得把真实照片、视频、录音、音乐或外部个人 JSON 放入仓库、Issue、PR、截图或 CI。
- 新增虚构素材时必须记录来源、生成方式、变换步骤和权利复核状态。
- 不得用真实个人文件演示错误或测试失败；请构造最小虚构样例。
